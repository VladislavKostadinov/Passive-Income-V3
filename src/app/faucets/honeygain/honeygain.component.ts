...
export class HoneygainComponent {
  ...
  honeySofa: string =
    '../../../assets/images/honeygain/landing_page_sofa_tv.svg';
  ...
  ngOnInit() {
    this.http
      .get('https://passive-income.icu/honeygain')
      .subscribe((data) => {});

    this.http.get('https://passive-income.icu/honeygainUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http
            .get('https://passive-income.icu/honeygainRatings')
            .subscribe(
              (data) => {
                if (data) {
                  ...
                  this.http
                    .get('https://passive-income.icu/honeygainComments')
                    .subscribe(
                      (data) => {
                        if (data) {
                          this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/honeygainPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
