...
@Component({
  selector: 'app-fire-faucet',
  templateUrl: './fire-faucet.component.html',
  styleUrls: ['./fire-faucet.component.css'],
})
export class FireFaucetComponent {
  ...
  ngOnInit() {
    this.http
      .get('https://passive-income.icu/firefaucet')
      .subscribe((data) => {});

    this.http.get('https://passive-income.icu/firefaucetUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http
            .get('https://passive-income.icu/firefaucetRatings')
            .subscribe(
              (data) => {
                if (data) {
                  ...
                  this.http
                    .get('https://passive-income.icu/firefaucetComments')
                    .subscribe(
                      (data) => {
                        if (data) {
                          this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/firefaucetPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
