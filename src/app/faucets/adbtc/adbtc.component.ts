...
@Component({
  selector: 'app-adbtc',
  templateUrl: './adbtc.component.html',
  styleUrls: ['./adbtc.component.css'],
})
export class AdbtcComponent {
  adbtc: string = '../../../assets/images/adbtc/adbtc.png';
  ...
  ngOnInit() {
    this.http.get('https://passive-income.icu/adbtc').subscribe((data) => {});

    this.http.get('https://passive-income.icu/adbtcUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http.get('https://passive-income.icu/adbtcRatings').subscribe(
            (data) => {
              if (data) {
                ...
                this.http
                  .get('https://passive-income.icu/adbtcComments')
                  .subscribe(
                    (data) => {
                      if (data) {
                        this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/adbtcPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
