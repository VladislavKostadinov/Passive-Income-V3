...
export class CointiplyComponent {
  ...
  ngOnInit() {
    this.http
      .get('https://passive-income.icu/cointiply')
      .subscribe((data) => {});

    this.http.get('https://passive-income.icu/cointiplyUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http
            .get('https://passive-income.icu/cointiplyRatings')
            .subscribe(
              (data) => {
                if (data) {
                  ...
                  this.http
                    .get('https://passive-income.icu/cointiplyComments')
                    .subscribe(
                      (data) => {
                        if (data) {
                          this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/cointiplyPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
