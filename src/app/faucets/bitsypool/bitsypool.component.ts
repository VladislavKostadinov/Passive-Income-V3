...
@Component({
  selector: 'app-bitsypool',
  templateUrl: './bitsypool.component.html',
  styleUrls: ['./bitsypool.component.css']
})
export class BitsypoolComponent {

  bitsy: string = '../../../assets/images/bitsypool/main.webp';

  register: string = '../../../assets/images/bitsypool/faucetpay.png';
  miner: string = '../../../assets/images/bitsypool/miner.png';
  faucet: string = '../../../assets/images/bitsypool/faucet.png';
  refer: string = '../../../assets/images/refer.webp'


  bitsyWall: string = '../../../assets/images/bitsypool/wall.jpg';
  ...
  ngOnInit() {
    this.http.get("https://passive-income.icu/bitsypoolUsers").subscribe(data => {
      if (data) {
        ...
        this.http.get("https://passive-income.icu/bitsypoolRatings").subscribe(data => {
          if (data) {
            ...
            this.http.get("https://passive-income.icu/bitsypoolComments").subscribe(data => {
              if (data) {
                this.listOfComments.push(data);
  ...
  addComment () {
    ...
    if (!this.maintenance) {
      this.http.post<any>("https://passive-income.icu/bitsypoolPost", 
