...
export class BitsypoolComponent {
  ...
  ngOnInit() {
    this.http.get('https://passive-income.icu/bitsy').subscribe((data) => {});
    this.http.get('https://passive-income.icu/bitsypoolUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http
            .get('https://passive-income.icu/bitsypoolRatings')
            .subscribe(
              (data) => {
                if (data) {
                  ...
                  this.http
                    .get('https://passive-income.icu/bitsypoolComments')
                    .subscribe(
                      (data) => {
                        if (data) {
                          this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/bitsypoolPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
