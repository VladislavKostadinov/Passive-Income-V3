...
@Component({
  selector: 'app-swagbucks',
  templateUrl: './swagbucks.component.html',
  styleUrls: ['./swagbucks.component.css'],
})
export class SwagbucksComponent {
  swag: string = '../../../assets/images/swagbucks/swagbucks.png';
  ...
  ngOnInit() {
    this.http
      .get('https://passive-income.icu/swagbucks')
      .subscribe((data) => {});

    this.http.get('https://passive-income.icu/swagbucksUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http
            .get('https://passive-income.icu/swagbucksRatings')
            .subscribe(
              (data) => {
                if (data) {
                  ...
                  this.http
                    .get('https://passive-income.icu/swagbucksComments')
                    .subscribe(
                      (data) => {
                        if (data) {
                          this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/swagbucksPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
