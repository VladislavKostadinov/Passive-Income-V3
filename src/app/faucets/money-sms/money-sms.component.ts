...
@Component({
  selector: 'app-money-sms',
  templateUrl: './money-sms.component.html',
  styleUrls: ['./money-sms.component.css'],
})
export class MoneySmsComponent {
  ...
  payment: string = '/assets/images/money-sms/pay.png';
  withdraw: string = '/assets/images/money-sms/sms.png';
  refer: string = '/assets/images/refer.webp';

  smsWall: string = '/assets/images/money-sms/background.webp';
    ...
    this.http.get('https://passive-income.icu/moneySMSUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http.get('https://passive-income.icu/moneySMSRatings').subscribe(
            (data) => {
              if (data) {
                ...
                this.http
                  .get('https://passive-income.icu/moneySMSComments')
                  .subscribe(
                    (data) => {
                      if (data) {
                        this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/moneySMSPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
