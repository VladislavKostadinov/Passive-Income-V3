...
@Component({
  selector: 'app-neoflojd',
  templateUrl: './neoflojd.component.html',
  styleUrls: ['./neoflojd.component.css']
})
export class NeoflojdComponent {
  ...
  ngOnInit() {
    this.http.get("https://passive-income.icu/neoflojdUsers").subscribe(data => {
      if (data) {
        ...
        this.http.get("https://passive-income.icu/neoflojdRatings").subscribe(data => {
          if (data) {
            ...
            this.http.get("https://passive-income.icu/neoflojdComments").subscribe(data => {
              if (data) {
                this.listOfComments.push(data);
  ...
  addComment () {
    ...
    if (!this.maintenance) {
      this.http.post<any>("https://passive-income.icu/neoflojdPost", 
