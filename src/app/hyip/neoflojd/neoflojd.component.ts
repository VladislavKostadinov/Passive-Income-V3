...
export class NeoflojdComponent {
  ...
  ngOnInit() {
    this.http
      .get('https://passive-income.icu/neoflojd')
      .subscribe((data) => {});

    this.http.get('https://passive-income.icu/neoflojdUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http.get('https://passive-income.icu/neoflojdRatings').subscribe(
            (data) => {
              if (data) {
                ...
                this.http
                  .get('https://passive-income.icu/neoflojdComments')
                  .subscribe(
                    (data) => {
                      if (data) {
                        this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/neoflojdPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
