...
export class EtccloudComponent {
  ...
  ngOnInit() {
    this.http.get("https://passive-income.icu/etccloudltdUsers").subscribe(data => {
      if (data) {
        ...
        this.http.get("https://passive-income.icu/etccloudltdRatings").subscribe(data => {
          if (data) {
            ...
            this.http.get("https://passive-income.icu/etccloudltdComments").subscribe(data => {
              if (data) {
                this.listOfComments.push(data);
  ...
  addComment () {
    ...
    if (!this.maintenance) {
      this.http.post<any>("https://passive-income.icu/etccloudltdPost", 
