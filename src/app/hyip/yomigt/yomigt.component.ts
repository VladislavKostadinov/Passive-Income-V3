...
@Component({
  selector: 'app-yomigt',
  templateUrl: './yomigt.component.html',
  styleUrls: ['./yomigt.component.css']
})
export class YomigtComponent {
  
  yomigt: string = '../../../assets/images/yomigt/logo2.jpg';

  reg: string = '../../../assets/images/yomigt/register.png';
  lifecycle: string = '../../../assets/images/yomigt/curve.png';
  withdraw: string = '../../../assets/images/yomigt/earn.png';

  refer: string = '../../../assets/images/refer.webp'

  yomigt_wall: string = '../../../assets/images/yomigt/wall.png';
  ...
  ngOnInit() {
    this.http.get("https://passive-income.icu/yomigtUsers").subscribe(data => {
      if (data) {
        ...
        this.http.get("https://passive-income.icu/yomigtRatings").subscribe(data => {
          if (data) {
            ...
            this.http.get("https://passive-income.icu/yomigtComments").subscribe(data => {
              if (data) {
                this.listOfComments.push(data);
  ...
  addComment () {
    ...
    if (!this.maintenance) {
      this.http.post<any>("https://passive-income.icu/yomigtPost", 
