...
export class NftfermaComponent {
  ...
  ngOnInit() {
    this.http
      .get('https://passive-income.icu/nftferma')
      .subscribe((data) => {});
    this.http.get('https://passive-income.icu/nftfermaUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http.get('https://passive-income.icu/nftfermaRatings').subscribe(
            (data) => {
              if (data) {
                ...
                this.http
                  .get('https://passive-income.icu/nftfermaComments')
                  .subscribe(
                    (data) => {
                      if (data) {
                        this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/nftfermaPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
