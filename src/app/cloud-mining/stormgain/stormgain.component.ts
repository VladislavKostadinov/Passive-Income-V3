...
@Component({
  selector: 'app-stormgain',
  templateUrl: './stormgain.component.html',
  styleUrls: ['./stormgain.component.css'],
})
export class StormgainComponent {
  stormgain: string = '../../../assets/images/stormgain/stormgain2.png';

  cloud_miner: string = '../../../assets/images/stormgain/cloud.png';
  trading: string = '../../../assets/images/stormgain/trading.webp';
  staking: string = '../../../assets/images/stormgain/stake2.png';
  refer: string = '../../../assets/images/refer.webp';

  f2hash_wall: string = '../../../assets/images/stormgain/stormgain5.jpg';
  ...
  ngOnInit() {
    this.http
      .get('https://passive-income.icu/stormgain')
      .subscribe((data) => {});
    this.http.get('https://passive-income.icu/stormgainUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http
            .get('https://passive-income.icu/stormgainRatings')
            .subscribe(
              (data) => {
                if (data) {
                  ...
                  this.http
                    .get('https://passive-income.icu/stormgainComments')
                    .subscribe(
                      (data) => {
                        if (data) {
                          this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/stormgainPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
