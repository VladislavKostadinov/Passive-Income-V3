...
@Component({
  selector: 'app-minelab',
  templateUrl: './minelab.component.html',
  styleUrls: ['./minelab.component.css']
})
export class MinelabComponent {

  
  minelab: string = '../../../assets/images/minelab/minelab_logo.png';

  customer_support: string = '../../../assets/images/minelab/customer_support.svg';
  mining: string = '../../../assets/images/minelab/mining.svg';
  payout: string = '../../../assets/images/minelab/payout.svg';
  refer: string = '../../../assets/images/refer.webp'


  minelab_wall: string = '../../../assets/images/minelab/minelab_wall.png';
  ...
  constructor(private router: Router, private db: AngularFireDatabase, private snackBar: MatSnackBar, 
    ...
    // this.db.list('cloud-mining/minelab/comments').valueChanges().subscribe(
    //   (data:any) => {
    //     if (data) {
  ...
  addComment () {
      // this.db.database.ref('cloud-mining').child('minelab').child('comments').child(this.numberOfComments.toString()).set(
      //   {
