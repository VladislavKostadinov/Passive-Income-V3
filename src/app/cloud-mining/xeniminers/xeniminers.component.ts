...
export class XeniminersComponent {
  ...
  ngOnInit() {
    this.http
      .get('https://passive-income.icu/xeniminers')
      .subscribe((data) => {});
    this.http.get('https://passive-income.icu/xeniminersUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http
            .get('https://passive-income.icu/xeniminersRatings')
            .subscribe(
              (data) => {
                if (data) {
                  ...
                  this.http
                    .get('https://passive-income.icu/xeniminersComments')
                    .subscribe(
                      (data) => {
                        if (data) {
                          this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/xeniminersPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
