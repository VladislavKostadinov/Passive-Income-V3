...
@Component({
  selector: 'app-f2hash',
  templateUrl: './f2hash.component.html',
  styleUrls: ['./f2hash.component.css'],
})
export class F2hashComponent {
  f2hash: string = '../../../assets/images/f2hash/f2hash_main.webp';

  package: string = '../../../assets/images/f2hash/machine.svg';
  info: string = '../../../assets/images/f2hash/web.png';
  economy: string = '../../../assets/images/f2hash/economy.svg';
  refer: string = '../../../assets/images/refer.webp';

  f2hash_wall: string = '../../../assets/images/f2hash/f2hash_wall4.jpg';
  ...
  ngOnInit() {
    this.http.get('https://passive-income.icu/f2hash').subscribe((data) => {});
    this.http.get('https://passive-income.icu/f2hashUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http.get('https://passive-income.icu/f2hashRatings').subscribe(
            (data) => {
              if (data) {
                ...
                this.http
                  .get('https://passive-income.icu/f2hashComments')
                  .subscribe(
                    (data) => {
                      if (data) {
                        this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/f2hashPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
