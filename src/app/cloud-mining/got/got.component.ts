...
export class GotComponent {
  ...
  ngOnInit() {
    this.http.get("https://passive-income.icu/gotUsers").subscribe(data => {
      if (data) {
        ...
        this.http.get("https://passive-income.icu/gotRatings").subscribe(data => {
          if (data) {
            ...
            this.http.get("https://passive-income.icu/gotComments").subscribe(data => {
              if (data) {
                this.listOfComments.push(data);
  ...
  addComment () {
    ...
    if (!this.maintenance) {
      this.http.post<any>("https://passive-income.icu/gotPost", 
