...
export class BlackBoxComponent {
  ...
  ngOnInit() {
    this.http.get('https://passive-income.icu/bbox').subscribe((data) => {});
    this.http.get('https://passive-income.icu/bboxUsers').subscribe(
      (data) => {
        if (data) {
          ...
          this.http.get('https://passive-income.icu/bboxRatings').subscribe(
            (data) => {
              if (data) {
                ...
                this.http
                  .get('https://passive-income.icu/bboxComments')
                  .subscribe(
                    (data) => {
                      if (data) {
                        this.listOfComments.push(data);
  ...
  addComment() {
    ...
    if (!this.maintenance) {
      this.http
        .post<any>('https://passive-income.icu/bboxPost', [
          this.guest,
          this.rate,
          this.cmnt,
        ])
